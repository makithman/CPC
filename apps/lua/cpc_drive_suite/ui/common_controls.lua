...
return function(__CPC)
  ...
  __CPC.SETTING_HELP = {
    ...
    throttleTransitionSpeed = 'How quickly the synchronized forward camera and FOV movement changes.',
    throttleFovTransitionSpeed = 'Compatibility value synchronized to the camera and FOV movement speed.',
